...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13702 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13702(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13704 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13704(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13710 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13710(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13713 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13713(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13723 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13723(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13730 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13730(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13696,callback){
var map__13697 = p__13696;
var map__13697__$1 = cljs.core.__destructure_map(map__13697);
var input = map__13697__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13697__$1,new cljs.core.Keyword(null,"code","code",1586293142));
