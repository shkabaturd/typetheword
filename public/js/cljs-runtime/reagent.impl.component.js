...
var or__5002__auto__ = (function (){var G__12023 = c;
var G__12023__$1 = (((G__12023 == null))?null:G__12023.constructor);
if((G__12023__$1 == null)){
return null;
} else {
return G__12023__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__12028 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12029 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12029);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12028);
}});
...
var c = this;
var G__12077_12122 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12077_12122 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12077_12122);
}
...
var renders_12124 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12125 = cljs.core.first(cljs.core.vals(renders_12124));
...
if((cljs.core.count(renders_12124) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12124))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12125)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12125], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
