...
var i_14731 = (self__.level + (1));
while(true){
if((i_14731 <= (new_level + (1)))){
(update[i_14731] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14733 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14733[i]));
} else {
x__$2.forward.push((((i < links_14733.length))?(links_14733[i]):null));
}

if((i < links_14733.length)){
(links_14733[i] = x__$2);
} else {
links_14733.push(x__$2);
}
...
var i_14740 = (0);
while(true){
if((i_14740 <= self__.level)){
var links_14742 = (update[i_14740]).forward;
if((x__$1 === (((i_14740 < links_14742.length))?(links_14742[i_14740]):null))){
(links_14742[i_14740] = (x__$1.forward[i_14740]));

var G__14749 = (i_14740 + (1));
i_14740 = G__14749;
continue;
} else {
var G__14750 = (i_14740 + (1));
i_14740 = G__14750;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__14771 = nx;
var G__14772 = (level__$1 - (1));
x = G__14771;
level__$1 = G__14772;
continue;
} else {
var G__14773 = x;
var G__14774 = (level__$1 - (1));
x = G__14773;
level__$1 = G__14774;
continue;
}
